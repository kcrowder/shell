...
# date: 05.19.2013
# by: keith crowder
# purpose: install debian packages for crunchbang linux
# script: crunchInstall.sh
#
##################
...
sudo cp -v /home/chlordane/.conkyrc conked.txt
...
sudo cat > /home/chlordane/.conkyrc << EOF
# conky configuration
#
...
sudo cp -v /home/chlordane/.config/tint2/tint2rc tinted.txt

sudo cat > /home/chlordane/.config/tint2/tint2rc << EOF
#---------------------------------------------
# TINT2 CONFIG FILE
#---------------------------------------------
...
sudo cp -v /home/chlordane/.config/openbox/autostart auto.txt
...
cat >> /home/chlordane/.config/openbox/autostart << EOF
## Display
